...
public class Video_More extends Activity{
	...
	private String type = "2",catid;//类型与栏目ID
	private TextView video_title;//标题控件
	private String video_title_text;//标题文本
	...
	void initView(){
		...
		catid = Video_Tools.more_catid+"";//获取的点击的栏目ID
		video_title_text = Video_Tools.more_title;//获取点击的栏目标题
		Videos_list = Videos_Input.init_VideoList(type, catid) ;//获取接口数据
		
		video_title = (TextView)findViewById(R.id.video_title);
		video_title.setText(video_title_text);
	...
	private void initListen() {
		...
		video_bodyView_more_lv.setOnItemClickListener(new OnItemClickListener(){
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				 ...
				 videoMore_intent.setClass(Video_More.this, VideoSecond.class);
	...
	public class ClickEnvent implements OnClickListener{
		...
		public void onClick(View v) {
			...
			case R.id.firstGame://第一游戏按钮
				...
				intent_f.setClass(Video_More.this, Videos_Main.class);
				Video_More.this.startActivity(intent_f);
				break;
			case R.id.weibokong://微博控按钮
				...
				intent_w.setClass(Video_More.this, Videos_Main.class);
				Video_More.this.startActivity(intent_w);
				break;
			case R.id.gamevideo://游戏视频按钮
				...
				intent_g.setClass(Video_More.this, Videos_Main.class);
				Video_More.this.startActivity(intent_g);
				break;
			case R.id.pictures_bib4://图片按钮
				...
				intentP.setClass(Video_More.this, Pictures_Main.class);
			...
			case R.id.pictures_bib1://新闻按钮
				...
				intentN.setClass(Video_More.this, NewsMainActivity.class);
			...
			case R.id.pictures_bib3://收藏按钮
				...
				intentc.setClass(Video_More.this, CollectsIndexActivity.class);
